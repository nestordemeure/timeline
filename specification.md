...
The native scrollbar is styled for an extra-thick (48px) appearance with a rectangular thumb. A fixed overlay displays lines scaled to each event's width (minimum 1px) at their final positions. Clicking anywhere on the bar jumps instantly to the corresponding point.
